define(['app/app', 'app/models', 'spin.js'],
function(HoneySens, Models, Spinner) {
    HoneySens.module('Views', function(Views, HoneySens, Backbone, Marionette, $, _) {
        ...
        Views.spinner = new Spinner.Spinner({lines: 13, length: 4, width: 2, radius: 6, corners: 1, rotate: 0, direction: 1, color: '#000',
            speed: 1, trail: 60, shadow: false, hwaccel: false, className: 'spinner', zIndex: 2e9, top: '50%', left: '50%'});
        Views.inlineSpinner = new Spinner.Spinner({lines: 10, length: 3, width: 2, radius: 4, corners: 1, rotate: 0, direction: 1, color: '#000',
            speed: 1, trail: 60, shadow: false, hwaccel: false, className: 'spinner', zIndex: 2e9, top: '50%', left: '50%'});
