define(['app/app',
        ...
        'tpl!app/modules/settings/templates/SMTPTemplates.tpl',
        'tpl!app/modules/settings/templates/SMTPTemplateDetails.tpl'],
function(HoneySens, ModalSettingsSaveView, ModalSMTPTemplatePreviewView, SMTPTemplatesTpl, SMTPTemplateDetailsTpl) {
    HoneySens.module('Settings.Views', function(Views, HoneySens, Backbone, Marionette, $, _) {
        ...
        var TemplateDetailsView = Marionette.ItemView.extend({
            template: SMTPTemplateDetailsTpl,
            tagName: 'form',
            events: {
